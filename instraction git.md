...
При работе в двух ветках одновременно, может возникнуть ситуация, когда в одной и другой ветке по разному изменили один и тот же блок. При слиянии этих веток, Git сообщит о конфликте и предложить выбрать ко
нкретные изменения и записать.
...
Для просмотра всех коммитов во всех ветках испоьзуем:

    git log --branches=*

Если необходимо вывести всю информацию по веткам в одну линию, используем команду:
